...
class TestValidatePlayers:
    ...
    def test_validate_players_with_issues(
        ...
        duplicate_warnings = [
            w for w in results["warnings"] if "duplicate player ids" in w
        ]
...
class TestValidatePlayerMatchStats:
    ...
    def test_validate_player_match_stats_success(
        ...
        results = validate_player_match_stats(
            sample_player_match_stats_df, player_ids, match_ids
        )
    ...
    def test_validate_player_match_stats_with_issues(
        self,
        ...
        results = validate_player_match_stats(
            sample_player_match_stats_df_with_issues, player_ids, match_ids
        )
        ...
        orphaned_players = [
            w for w in results["warnings"] if "orphaned player ids" in w
        ]
    ...
    def test_validate_player_match_stats_empty(
        self, sample_players_df, sample_matches_df
    ):
        """
...
class TestValidateMatchEvents:
    ...
    def test_validate_match_events_success(
        self,
        ...
        results = validate_match_events(
            sample_match_events_df, match_ids, team_ids, player_ids
        )
    ...
    def test_validate_match_events_with_issues(
        self,
        ...
        results = validate_match_events(
            sample_match_events_df_with_issues, match_ids, team_ids, player_ids
        )
        ...
        duplicate_warnings = [
            w for w in results["warnings"] if "duplicate event ids" in w
        ]
        assert len(duplicate_warnings) > 0

    def test_validate_match_events_empty(
        self, sample_matches_df, sample_teams_df, sample_players_df
    ):
        """
